...
describe TimeOffsController do
  ...
  let(:valid_attributes) { { "start_date" => "2013-11-12" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved time_off as @time_off" do
        ...
        post :create, {:time_off => { "start_date" => "invalid value" }}, valid_session
        assigns(:time_off).should be_a_new(TimeOff)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested time_off" do
        ...
        TimeOff.any_instance.should_receive(:update).with({ "start_date" => "2013-11-12" })
        put :update, {:id => time_off.to_param, :time_off => { "start_date" => "2013-11-12" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the time_off as @time_off" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TimeOff.any_instance.stub(:save).and_return(false)
        put :update, {:id => time_off.to_param, :time_off => { "start_date" => "invalid value" }}, valid_session
        assigns(:time_off).should eq(time_off)
      end
